 ...
 */
  ...
  /**
   * Internal function to set the title on the main document dynamically
   *
   * @param string $title Set of elements to list
   * @access public
   */
	function metatitle($title)
	{
		$out = sprintf($this->tags['metatitle'],$title);
  ...
  /**
   * Internal function to sanitize a string
   *
