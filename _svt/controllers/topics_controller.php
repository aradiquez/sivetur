...
function add()
{
  ...
  $error=0;# para controlar el Topic de error
...
function delete($id)
{
	...
	if((count($datosCat['Noticias'])>0))
 	{
		//$this->Session->setflash('No es posible eliminar el Topic '.$datosCat[$this->model]['name'].', porque tiene registros relacionados.');	
