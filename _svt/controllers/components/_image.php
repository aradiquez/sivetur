...
class ImageComponent extends Object
{
    ...
    var $tn_image_location = '../../../fotos/';
	var $dirmarca = '../../../fotos/marca/';
        ...
        // echo "entro";
					...
					$smalluploaddir = "img/".$folderName."/small"; // the /small/ directory for thumbnails
                                        */
                                        ...
                                        //  $biguploaddir = $this->image_location.$folderName; // the /big/ directory
					//  $smalluploaddir = $this->image_location.$folderName; // the /small/ directory for thumbnails
					 /// $this->image_location=$biguploaddir;
                                       // }else
                                       // {
...
//echo $imgsize;
                                           if($data[$modelo][$datakey]['size'] > 300000)
		                              {
                                                $this->addError('TamaÒo del Archivo supera el maximo permitido 300 kb');
                                                return false;
                                            }
			     ...
			     if($square) {
					...
					*/
					$this->crop_img($tempfile, $thumbscale, $croppedfile);
		             ...
		             // if($marca)
				//{
				// $this->marcadeagua($tempfile,$this->dirmarca."marca.png",$tempfile,100);
				//}	    
			    if($fixed){
                                 $this->cropFixed($tempfile,$this->wi,$this->he, $resizedfile,100);
                                    //$this->thum($tempfile, $imgscale, $resizedfile);
                              }else{
