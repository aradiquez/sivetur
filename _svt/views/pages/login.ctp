...
<link rel="icon" href="<?=$this->webroot . 'panel.ico'?>" type="image/x-icon" />
<link rel="shortcut icon" href="<?=$this->webroot . 'panel.ico';?>" type="image/x-icon" />
<?=$html->css('login');?>
</head>
<body>
<div id="content">
	<?=$html->image('logo.gif',array("alt"=>"Sivetur", "title"=>"Sivetur"))?>

	<form method='post' action="">
	<fieldset class="fieldsetlog">
	<legend>Panel de Acceso Administratvo</legend>
	<?
	...
	<div class="trform">
			<div class="tdlabels"><label for="password">Contraseña:</label></div>
			<div class="tdimputs">
				<input type='password' name='password' id='password'/>
			</div>
	</div>
	<div class="trform">
	<input type='submit' class="boton1" value='Entrar'/>
	</div>
	<?
