 ...
 *
 */
 function slug($string, $replacement = '-', $length = 255) {
    //echo $string;
    /*static $novalidos = "áéíóúÁÉÍÓÚàèìòùÀÈÌÒÙâêîôûÂÊÎÔÛäëïöüÄËÏÖÜÇçÅåÕõØøÿñÑ";
    static $validos = "aeiouAEIOUaeiouAEIOUaeiouAEIOUaeiouAEIOUCcAaOoOoynN";
    $string = strtolower(strtr($string,$novalidos,$validos));*/
    //echo $string;
