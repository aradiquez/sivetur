...
class HomesController extends AppController{
    ...
    function getInfoSlideShow(){
      ...
      $hoy = date("Y-m-d");
      $fields = array('id','name', 'introduccion', 'precio');
    ...
    function getTagsForSearch(){
       return $this->Tag->find('all', array('conditions' => array('estado' => "A"), 'fields' => array('id','name'), 'limit' => 20));
    }
