                ...
                <? } ?>
      						<div class="itemlabel3">
      							<div class="labelright">
      								<br/>
      								<br/><br/><br/>	
                      <?=$html->link('M&aacute;s informaci&oacute;n', array('controller' => 'turismo_nacional', 'action' => 'index',$offt['ProgramasCircuito']['id']), array('escape' => false, 'class' => "bookbtn mt1") );?>
      							</div>
      							<div class="labelleft2">			
      								<b><?= $offt['ProgramasCircuito']['name']?></b><br/><br/>
