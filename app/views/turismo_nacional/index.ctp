...
$this->set('SEOH1',"Ofertas en ".$seccion_title.", ".$seccion['Section']['title']." | ".__('_TITULO', true).__('_INICIO', true));
		...
		<div class="container mt25 offset-0">
			...
			<div class="col-md-12 pagecontainer2 offset-0">
				<div class="hpadding50c">
					<p class="lato size30 slim"><h2><?=$seccion_title?></h2></p>
          ...
          <!-- LEFT IMG -->
					<div class="cpdd01">
            <? if (!empty($seccion_first_photo[0]) ){ ?>
              <div class="col-md-8" style="float: left; margin: 5px;">
                <?= $this->Html->image( '../fotos/img.php?i='.$seccion_first_photo[0]['name']."&amp;w=677&amp;h=600&amp;radius=0",  array('alt'=>$seccion_first_photo[0]['details'], 'title'=>$seccion_first_photo[0]['details'], 'class' => "fwimg"));?>
              </div>
            <? } ?>
            <div class="opensans size13 grey">
							<?=$seccion_text?>
						</div>
            <? if (!empty($seccion_photos)) {  ?>
              <div class="clearfix"></div>
    					<br/> <br/>
    					<div class="line3"></div>
    					<br/><br/>
              <?php echo $this->element("programas/_photo_gallery", array('photos' => $seccion_photos) ); ?>		
		        <? }  ?>
  					<div class="clearfix"></div>
  					<br/> <br/>
  					<div class="line3"></div>
                  ...
                  <? } ?>
        						<div class="itemlabel3">
        							<div class="labelright">
        								<br/>
        								<br/><br/><br/>	
                        <?=$html->link('M&aacute;s informaci&oacute;n', array('controller' => 'turismo_nacional', 'action' => 'index',$offt['ProgramasCircuito']['id'], slug($offt['ProgramasCircuito']['name'])), array('escape' => false, 'class' => "bookbtn mt1") );?>
        							</div>
        							<div class="labelleft2">			
        								<b><?=$html->link("<h3>".$offt['ProgramasCircuito']['name']."</h3>", array('controller' => 'turismo_nacional', 'action' => 'index',$offt['ProgramasCircuito']['id'], slug($offt['ProgramasCircuito']['name'])), array('escape' => false));?></b><br/><br/>
          ...
          <? if (!empty($ofertas)) {  ?>
            <div class="clearfix"></div>
  					<br/>
            <?php echo $this->element("programas/_ofertas_relacionadas", array('ofertas' => $ofertas) ); ?>		
	        <? }  ?>
