          ...
          <table style="width:750px; background-color:#ffffff;" border="0" width="600" cellspacing="0" cellpadding="20" bgcolor="#ffffff">
            ...
            <tr>
              <td width="100%" rowspan="1" colspan="1" >
                ...
                <p>Usted ha solicitado mas informaci&oacute;n acerca de la oferta <?=$oferta_nombre?></p>
                ------------------------------------------------------------------------<br/>
                <p>Gracias por usar nuestros servicios</p>	
                <p>En breve nos estaremos comunicando con usted para aclara todas sus dudas acerca de la oferta <?=$oferta_nombre?></p>
                <br/>
                <p>Saludos codiales,<br/>
                  Equipo de Sivetur S.A.</p>
                ------------------------------------------------------------------------<br/>
