			<!-- Navigation-->
			  ...
			  <div class="navbar-collapse collapse">
				<ul class="nav navbar-nav navbar-right">
					  ...
					  <li>
							<div class="row dropwidth01">
								...
								<ul class="droplist col-md-4">
								  ...
								  <li><a href="intro3.html">Intro 3 - slides2</a></li>
								</ul>
								<ul class="droplist col-md-4">
				  ...
				  <li class="dropdown">
					<a data-toggle="dropdown" class="dropdown-toggle" href="#">Pages <span class="badge indent0">5</span><b class="lightcaret mt-2"></b></a>
					<ul class="dropdown-menu posright-0">
					  <li>
							<div class="row dropwidth02">
								<ul class="droplist col-md-6">
								  ...
								  <li><a href="profile.html">User Profile</a> <span class="green">new</span></li>
								...
								<ul class="droplist col-md-6">
								  ...
								  <li><a href="dashboard/index.html">Dashboard</a> <span class="green">new</span></li>								  
								  <li><a href="about.html">About</a> <span class="green">new</span></li>
								  <li><a href="blog.html">Blog page</a> <span class="green">new</span></li>
								  <li><a href="blog-details.html">Blog details</a> <span class="green">new</span></li>
