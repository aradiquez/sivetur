...
<?= $javascript->link('ckeditor/ckeditor.js')?>
 ...
 echo "<h2>Nuevo Programa y Circuito</h2>";
    ...
    echo $form->create('ProgramasCircuito', array('action'=>'edit/', 'type' => 'file'));
    echo $form->input('id', array('type'=>'hidden', 'value'=> $form->value('ProgramasCircuito.id')));
?> 
...
<fieldset>
    <div class="input-group">
         ...
         <?= $tree->createSelect('ProgramasCircuito/name/id', $parentArray, $form->value('ProgramasCircuito.parent_id'));?>
    </div>
    <br/>
    <div class="input-group">
