...
<? echo  "<div class='panel'>"; 
 ...
 echo "<h2>Nuevo Oferta</h2>";
 
    echo $form->create('Oferta', array('type' => 'file'));
?> 
...
<fieldset>
    <div class="input-group">
         ...
         <?= $tree->createSelectRelated('Oferta/programacircuito_id/ProgramasCircuito/name/id', $ProgramaCircuitoArray);?>
    </div>
    <br/>
    <div class="input-group">
    ...
    <hr/>
    <div class="optional">   
        <?php echo $html->link('Lista de ofertas', '/ofertas/index')?>
    </div>   
</div>